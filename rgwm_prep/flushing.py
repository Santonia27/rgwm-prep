...
def process_flushing(fn_path: str, inlaat_measurements: str = None ): 
    ...
    This may be diffrent in your case.
    ...
    for waterboard in wb_params_dict:
        ...
        # Calculate flushing based on season
            ...
            if date_object.strftime("%B") in seasons.summer_months:
                flushing = (10*summer_flushing*area/days) / 1000000 # Calculation from Excel water boards
            elif date_object.strftime("%B") in seasons.winter_months:
                flushing = winter_flushing/ 1000000 # Calculation from Excel water boards
            else:
                break
    ...
    if inlaat_measurements: 
        total_flushing = inlaat_measurements/ 1000000 #NOTE! This may need adaptation if measurements are available
    else:
